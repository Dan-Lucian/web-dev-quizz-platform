  ...
  <WrapperPage>
    ...
    <Section>
      ...
      <WrapperText colorBorder="green">
        ...
        <Text>
          This is a platform that has access to a collection of questions about
          various web development related topics. For now this platform has
          questions about internet, html, css, javascript and react.
        </Text>
        <Text>
          ...
          find yourself thinking - "Oh right, that's an actual thing.", then the
          planned purpose has been achieved!
        </Text>
        <Text>
    ...
    <Section>
      ...
      <WrapperText colorBorder="red">
        ...
        <List>
          ...
          <li>
            In case you select a main topic (ex: javascript) the questions will
            be about the whole topic.
          </li>
          <li>
          ...
          <li>
            But it is not possible to choose a main topic and a subtopic at the
            same time.
          </li>
